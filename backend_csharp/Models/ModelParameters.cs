...
namespace DormClimateBackend.Models
{
    ...
    {
            public double ThermalCapacity { get; set; } = 1000.0;     // C (J/°C)
            public double MaxHeaterPower { get; set; } = 2000.0;       // P_Heater (W)
            public double MaxACPower { get; set; } = 2000.0;           // P_AC (W)
            public double Conductance { get; set; } = 50.0;            // k (W/°C)
